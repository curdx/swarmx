...
> 对齐北极星：`/Users/wdx/opc/flockmux-core/.claude/worktrees/funny-raman-47113f/.ux-review/chat-redesign.md`（§2 七原则、§3 整屏布局、§4 逐组件、§6 P0/P1/P2 分期）。
...
> 抽出跨组件复用的视觉基元，避免每个组件各写一套。全部用 `/Users/wdx/opc/flockmux-core/web/src/styles/global.css` 现有 CSS 变量，**不新增颜色**。
...
**关键文件锚点（绝对路径）**：
- 聊天主体：`/Users/wdx/opc/flockmux-core/web/src/components/MessagesPanel.tsx`（Composer/草稿 :258-1023、@autocomplete :728、buildRows :219、系统消息壳 :1178、USER :1211、ORCH :1278、过滤 :528、TimeDivider :1571、NewMessagesDivider :1587、ReasoningDisclosure :1606、PendingBubble :1670、键盘 :988、pending 推断 :672-706）
- 诚实层：`/Users/wdx/opc/flockmux-core/web/src/lib/agent.ts`（`resolveMemberVisual` :265、`formatActivityLine` :363、`roleColor*` :42-68、阈值 :126-128）
- 复用面板/时间线：`/Users/wdx/opc/flockmux-core/web/src/components/agent/AgentDrawer.tsx`（五 tab :82-93、Header/ActionRow :350-459、`formatDelta` :96）、`AgentActivityLog.tsx`、`XtermPane.tsx`
- 复用模板：`/Users/wdx/opc/flockmux-core/web/src/components/workspace/OrchestratorFailureCard.tsx`、`/Users/wdx/opc/flockmux-core/web/src/components/TaskActivity.tsx`、`/Users/wdx/opc/flockmux-core/web/src/components/ModelPicker.tsx`、`/Users/wdx/opc/flockmux-core/web/src/lib/dagEdgeDerivation.ts:51-95`、`/Users/wdx/opc/flockmux-core/web/src/components/ChatMarkdown.tsx`
- 接线点：`/Users/wdx/opc/flockmux-core/web/src/routes/workspace/views/Chat.tsx`（cliReadiness :200、orchestratorFailure :446、retryOrchestrator :486、emptyStateOverride :862、ledger :681）
- 类型/协议：`/Users/wdx/opc/flockmux-core/web/src/api/types.ts`（MessageMeta :143、ThoughtTrace :177、AgentActivity :454、SwarmAgentState :429、AgentInfo :81-135、ThreadDiff :366、MergeResult :377）、`/Users/wdx/opc/flockmux-core/crates/flockmux-protocol/src/ws_swarm.rs`（AgentActivity :74-97、AgentState 七态 :102-118）
- 后端事实（P0 接现有信号）：`/Users/wdx/opc/flockmux-core/crates/flockmux-server/src/routes/rest.rs`（看门狗 :33,711-743、Spawning 同步发 :670、activity 端点读 ring :1125、interrupt/resume/all :1806/1824/1861、attachment :2838、optimize :2392）、`/Users/wdx/opc/flockmux-core/crates/flockmux-server/src/routes/workspaces.rs`（diff :816、merge :882）
- 后端持久化框架（P1+ emit 复用）：`/Users/wdx/opc/flockmux-core/crates/flockmux-storage/src/store.rs`（messages kind+meta :1070、last_activity_at :438、未读 :1531）、`/Users/wdx/opc/flockmux-core/crates/flockmux-server/src/wake.rs:389`（kind+meta+broadcast+store 可复制模式）
- token：`/Users/wdx/opc/flockmux-core/web/src/styles/global.css`；i18n：`/Users/wdx/opc/flockmux-core/web/src/i18n/locales/{zh,en}.json`
